...
>
    ...
    <button
        type="submit"
        class="relative flex {{ $isCompact ? 'size-9' : 'size-11' }} cursor-pointer items-center justify-center rounded-full border shadow-lg backdrop-blur motion-safe:transition-transform motion-safe:duration-200 motion-safe:hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-300 disabled:cursor-wait disabled:opacity-60 {{ $collectionId ? 'border-rose-300/80 bg-rose-500 text-white shadow-rose-950/40 hover:bg-rose-400' : 'border-white/80 bg-white/85 text-rose-600 shadow-black/40 hover:bg-white' }}"
